...
function _generateHtml(){
  ...
  while(t_idx < text.length && cnt < 30){
    ...
    ////////////////////////////
    // Close any markup sections that end on max == t_idx
    // Note that it may be that we have to close a markup
    ...
    ///////////////////////////////
    // Open any new markup sections, starting on min == t_idx
    ...
    ///////////////////////////////
    // Re-open any markup sections we were forced to close
    ...
    ///////////////////////////////
    // Add the text until the next markup change
